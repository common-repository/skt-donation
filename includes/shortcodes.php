...
<div class="skt_donation-plugin-container">
	...
	$payment_gatway_result = sanitize_text_field(isset($_GET['payment_gatway_result']) ? $_GET['payment_gatway_result'] : '');
	...
	if($payment_gatway_result=="result"){ 
			...
			$payment_result_success = sanitize_text_field(isset($_GET['payment_result_success']) ? $_GET['payment_result_success'] : '');
			if($payment_result_success !=''){
				$payment_result_success = sanitize_text_field($_GET['payment_result_success']);
			}
			$payment_gatway="";
			$payment_gatway = sanitize_text_field(isset($_GET['payment_gatway']) ? $_GET['payment_gatway'] : '');
			if($payment_gatway !=''){
				$payment_gatway = sanitize_text_field($_GET['payment_gatway']);
			}
			$paymentMessage_failed = sanitize_text_field(isset($_GET['payment_fail']) ? $_GET['payment_fail'] : '');
			if($paymentMessage_failed !=''){
				$paymentMessage_failed = sanitize_text_field($_GET['payment_fail']);
			}
		...
		$tabe_paypal_simple = sanitize_text_field(isset($_GET['tabe_paypal_simple']) ? $_GET['tabe_paypal_simple'] : '');
		...
		$paypal_subscription = sanitize_text_field(isset($_GET['paypal_subscription']) ? $_GET['paypal_subscription'] : '');
		if($paypal_subscription !=''){
			$paypal_subscription = sanitize_text_field($_GET['paypal_subscription']);
  ...
  <div> 
	...
	<?php 
	$payment_success = sanitize_text_field(isset($_GET['payment_success']) ? $_GET['payment_success'] : '');
	if ($payment_success !='') {
		echo $payment_success = sanitize_text_field($_GET['payment_success']);	
	}	
	?>
